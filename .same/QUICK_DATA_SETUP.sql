...
('Budget Officer', 'Manages budget and PIGAS sync'),
...
INSERT INTO expense_types (code, name, description, requires_quotes, is_active) VALUES
('TRAV', 'Travel & Accommodation', 'Travel expenses and accommodation', false, true),
('FUEL', 'Fuel & Vehicle', 'Fuel and vehicle maintenance', false, true),
('STAT', 'Stationery & Supplies', 'Office supplies and stationery', true, true),
('MAINT', 'Maintenance & Repairs', 'Equipment and facility maintenance', true, true),
('PROF', 'Professional Services', 'Consulting and professional services', true, true),
('EQUIP', 'Equipment', 'Equipment purchases', true, true),
('IT', 'IT Equipment & Services', 'IT equipment and software', true, true),
('UTIL', 'Utilities', 'Water, electricity, internet', false, true)
ON CONFLICT (code) DO NOTHING;

-- Step 4: Insert Suppliers
INSERT INTO suppliers (code, name, contact_person, email, phone, bank_name, bank_account, is_active) VALUES
('BB001', 'Brian Bell Ltd', 'John Smith', 'john@brianbell.com.pg', '325-1234', 'BSP', '1234567890', true),
('SS001', 'Stop & Shop', 'Mary Jones', 'mary@stopshop.com.pg', '325-2345', 'Westpac', '0987654321', true),
('PNG001', 'PNG Office Supplies Ltd', 'Peter Kila', 'peter@pngoffice.com.pg', '325-3456', 'ANZ', '1122334455', true),
('EM001', 'Ela Motors', 'Sarah Wani', 'sarah@elamotors.com.pg', '325-4567', 'BSP', '5566778899', true),
('IT001', 'ICT Solutions PNG', 'David Tau', 'david@ictsolutions.com.pg', '325-5678', 'Westpac', '9988776655', true)
ON CONFLICT (code) DO NOTHING;
