-- ============================================
-- UNRE Quick Data Setup - FIXED VERSION
-- Run each section separately if needed
-- ============================================

-- ========================================
-- SECTION 1: ROLES (Run this first)
-- ========================================
...
-- ========================================
-- SECTION 2: COST CENTRES (Run after roles)
-- ========================================
...
-- ========================================
-- SECTION 3: EXPENSE TYPES (Run after cost centres)
-- ========================================
...
-- ========================================
-- SECTION 4: SUPPLIERS (Run after expense types)
-- ========================================
...
-- ========================================
-- SECTION 5: BUDGET LINES (Run after cost centres)
-- ========================================
...
-- ========================================
-- SECTION 6: APPROVAL WORKFLOWS (Run last)
-- ========================================
...
SELECT 'Run the verification query to check your data:' as next_step;
SELECT 'SELECT ''Roles'' as table_name, COUNT(*) FROM roles UNION ALL SELECT ''Cost Centres'', COUNT(*) FROM cost_centres;' as verification_query;
