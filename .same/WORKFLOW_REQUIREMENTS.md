...
**Process:**
1. Request submitted
2. **Automatic Budget Check** against AAP (PIGAS data)
...
7. **Manual entry into PIGAS** (record payment)
...
CREATE TABLE payment_tracking (
  ...
  pigas_entry_confirmed BOOLEAN DEFAULT FALSE,
  pigas_entry_date TIMESTAMPTZ,
...
5. **PIGAS Entry Required**
   - To: Finance Officer
   - Content: Reminder to enter payment in PIGAS
