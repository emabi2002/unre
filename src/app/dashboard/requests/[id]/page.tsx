...
interface GERequest {
  ...
  budget_lines?: { description: string; pigas_vote_code: string };
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          ...
          budget_lines (description, pigas_vote_code),
          ge_request_items (*),
          ge_approvals (
            *,
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">{request.budget_lines?.pigas_vote_code}</p>
            </div>
