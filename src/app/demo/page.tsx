        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-slate-600 mb-4">Manage budget, commitments, and payments with PIGAS integration.</p>
              <ul className="space-y-2 mb-4">
                <li className="flex items-start gap-2 text-sm">
                  <CheckCircle className="h-4 w-4 text-green-600 mt-0.5" />
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              {
                number: "03",
                title: "Budget Tracking & PIGAS Integration",
                description: "Real-time visibility into budget vs actual expenditure vs commitments for all cost centres",
                features: ["AAP budget line mapping", "PIGAS synchronization", "Commitment tracking", "Available balance alerts"],
              },
              {
                number: "04",
